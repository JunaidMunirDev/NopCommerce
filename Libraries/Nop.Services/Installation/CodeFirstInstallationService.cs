    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallTopics()
        {
            ...
            var topics = new List<Topic>
            {
                ...
                new Topic
                {
                    ...
                    Body =
                        "<p>Online shopping is the process consumers go through to purchase products or services over the Internet. You can edit this in the admin site.</p><p>If you have questions, see the <a href=\"https://www.visionplus.com.pk/\">Documentation</a>, or post in the <a href=\"https://www.visionplus.com.pk/\">Forums</a> at <a href=\"https://www.visionplus.com.pk/\">Visionplus.com.pk</a></p>",
                    TopicTemplateId = defaultTopicTemplate.Id
                },
                new Topic
                {
        ...
        protected virtual void InstallSettings()
        {
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                FacebookLink = "https://www.visionplus.com.pk/",
                TwitterLink = "https://www.visionplus.com.pk/",
                YoutubeLink = "https://www.visionplus.com.pk/",
        ...
        protected virtual void InstallNews(string defaultUserEmail)
        {
            ...
            var news = new List<NewsItem>
            {
                new NewsItem
                {
                    AllowComments = true,
                    LanguageId = defaultLanguage.Id,
                    Title = "About Vision Plus",
                    Short = "It's stable and highly usable. From downloads to documentation, www.visionplus.com.pk offers a comprehensive base of information, resources, and support to the nopCommerce community.",
                    Full = "<p>For full feature list go to <a href=\"https://www.visionplus.com.pk/\">visionplus/</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow
                },
                new NewsItem
